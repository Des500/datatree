...
<head>
    ...
    <link rel="stylesheet" href="/public/css/forms.min.css?<?=time()?>">
    <link rel="stylesheet" href="/public/css/user.min.css?<?=time()?>">
    <link rel="stylesheet" href="/public/css/menu.min.css?<?=time()?>">
